  ...
  return (
    <section className="hero-section text-center mt-32 flex flex-col">
      ...
      <h2 className="mt-5 text-gray-600 sm:text-xl">
        Nexx is an open-source tool for developers who want ot launch their
        ideas faster.
      </h2>
      <div className="mx-auto mt-5 flex max-w-fit space-x-4">
        <a
          href="#get-started"
          className="rounded-full border px-5 py-2 text-sm font-medium shadow-sm border-black bg-black text-white hover:ring-gray-400 hover:ring-2"
        >
          Get Started
        </a>
        ...
        <a
          href="#features"
          className="rounded-full border px-5 py-2 text-sm font-medium shadow-sm border-gray-200 bg-white text-black hover:ring-gray-300 hover:ring-2"
        >
          Learn More
        </a>
      </div>
